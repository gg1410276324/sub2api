export default {
    ...
    affiliates: {
      agentsDescription: 'View weekly and monthly recharge sales generated by every agent',
    ...
    groups: {
      ...
      modelsList: {
        ...
        hint: 'Select from models mapped by upstream accounts in this group. Selected models are shown to users and can be bound to API keys.',
