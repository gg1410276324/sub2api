export default {
  ...
  keys: {
    ...
    noModelsConfigured: 'No selectable models are configured for this group. Contact an administrator.',
    modelRestrictionHint: 'This API key can only call the selected model.',
    statusLabel: 'Status',
