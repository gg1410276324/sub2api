...
const (
	...
	// FieldAllowedModel holds the string denoting the allowed_model field in the database.
	FieldAllowedModel = "allowed_model"
...
var (
	...
	// DefaultAllowedModel holds the default value on creation for the "allowed_model" field.
	DefaultAllowedModel string
	// AllowedModelValidator is a validator for the "allowed_model" field. It is called by the builders before save.
	AllowedModelValidator func(string) error
...
// ByAllowedModel orders the results by the allowed_model field.
func ByAllowedModel(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldAllowedModel, opts...).ToFunc()
}
