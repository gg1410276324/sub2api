...
func init() {
	...
	// apikeyDescAllowedModel is the schema descriptor for allowed_model field.
	apikeyDescAllowedModel := apikeyFields[4].Descriptor()
	// apikey.DefaultAllowedModel holds the default value on creation for the allowed_model field.
	apikey.DefaultAllowedModel = apikeyDescAllowedModel.Default.(string)
	// apikey.AllowedModelValidator is a validator for the "allowed_model" field. It is called by the builders before save.
	apikey.AllowedModelValidator = apikeyDescAllowedModel.Validators[0].(func(string) error)
