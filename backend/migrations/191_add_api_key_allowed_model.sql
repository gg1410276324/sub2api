ALTER TABLE api_keys
    ADD COLUMN IF NOT EXISTS allowed_model VARCHAR(255) NOT NULL DEFAULT '';

COMMENT ON COLUMN api_keys.allowed_model IS
    'Exact model this API key may call; empty keeps legacy unrestricted behavior';
...
BEGIN
    ...
    IF OLD.key IS DISTINCT FROM NEW.key
       ...
       OR OLD.allowed_model IS DISTINCT FROM NEW.allowed_model
